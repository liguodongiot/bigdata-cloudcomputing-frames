...
public class ReflectTest {
    ...
    public void init() throws Exception {
        className = "com.lgd.base.reflect.Person";
    ...
    public void otherMethod() throws Exception {
        ...
        System.out.println(Class.forName("com.lgd.base.reflect.CityEnum").isEnum());

        //判断当前的Class对象表示是否是接口
        System.out.println(personClass.isInterface());
        System.out.println(Class.forName("com.lgd.base.reflect.ExtInfoInterface").isInterface());
