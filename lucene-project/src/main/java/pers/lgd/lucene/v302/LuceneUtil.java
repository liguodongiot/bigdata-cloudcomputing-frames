...
//    static{
//        try {
//            directory =  FSDirectory.open(new File("E:/IndexDb2"));
...
//            String value = document.get(name);//1/淘宝/淘宝是一家IT互联网公司
...
//        Article aritcle = new Article(1,"淘宝","淘宝是一家IT互联网公司。");
